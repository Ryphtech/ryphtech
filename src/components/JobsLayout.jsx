...
const JobsLayout = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'Companies', href: '/jobs/companies', icon: Building2 },
    { name: 'Students', href: '/jobs/students', icon: GraduationCap },
  ];
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <Link to="/jobs" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900">JobsPortal</span>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">JobsPortal</span>
              </div>
              <p className="text-gray-300 mb-4 max-w-md">
                Connecting talented students with innovative companies. 
                Find your next career opportunity or discover the perfect candidate.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Find Talent</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Pricing</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Company Dashboard</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm">
                © 2024 JobsPortal. All rights reserved.
              </p>
              <div className="flex space-x-6 mt-4 md:mt-0">
                <a href="/" className="text-gray-400 hover:text-white text-sm transition-colors">Back to RyphTech</a>
